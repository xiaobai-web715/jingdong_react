...
const AddressMod = (props) => {
    ...
    const delData = () => {
        Modal.alert('' , '确认要删除吗?' , [
            ...
            {text : '确认' , onPress : () => {
                let url = config.baseUrl + 'api/user/address/del?uid='+uid+'&aid='+aid+'&token='+config.token;
    ...
    return (
        <div className='add-page'>
            <SubHeader title='修改收货地址' right-text="删除" rightBtn={delData.bind(null)}></SubHeader>
